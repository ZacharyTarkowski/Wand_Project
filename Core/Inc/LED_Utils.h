...
typedef enum { 
	...
	LED_COLOR_1 = LED_PIN_RED | LED_PIN_GREEN,
	LED_COLOR_2 = LED_PIN_RED | LED_PIN_BLUE,
	LED_COLOR_3 = LED_PIN_GREEN | LED_PIN_BLUE,
	LED_COLOR_4 = LED_PIN_RED | LED_PIN_GREEN | LED_PIN_BLUE
